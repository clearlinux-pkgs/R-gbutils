...
Version  : 0.3.0
Release  : 1
URL      : https://cran.r-project.org/src/contrib/gbutils_0.3-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gbutils_0.3-0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1535141399
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library gbutils|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
